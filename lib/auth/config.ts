...
export const { handlers, signIn, signOut, auth } = NextAuth({
  providers: [
    GitHub({
      clientId: getSetting('github.app.clientId') ?? process.env.GITHUB_APP_CLIENT_ID ?? '',
      clientSecret: getSetting('github.app.clientSecret') ?? process.env.GITHUB_APP_CLIENT_SECRET ?? '',
      authorization: {
